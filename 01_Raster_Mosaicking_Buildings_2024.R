...
result_path <- paste0(drive_path, "Input_Data/Mosaic_Buildings_2024/") # Result path
...
# Define folder names
folders <- c("Malawi_Covs/2024_Buildings","Mozambique_Covs/2024_Buildings", 
             "Tanzania_Covs/2024_Buildings", "Zambia_Covs/2024_Buildings")
